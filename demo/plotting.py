...
for day_type in ['weekdays', 'weekends']:
    ...
    ysmooth = lowess(day_type_prop['prop_casual'], day_type_prop['temp'] * 41, return_sorted=False)

    # Plot the smoothed line
    sns.lineplot(day_type_prop['temp'] * 41, ysmooth, label=day_type)
# ==================================================================
...
for day_type in ['weekdays', 'weekends']:
    ...
    xobs = (sampled_data ['temp'] * 41).to_numpy()
